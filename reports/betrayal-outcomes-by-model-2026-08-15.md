...
PNG: [`outcomes-by-model.png`](docker-treason-2026-08-15/outcomes-by-model.png) · [`arm-vs-init.png`](docker-treason-2026-08-15/arm-vs-init.png) · [`endings.png`](docker-treason-2026-08-15/endings.png) · [`pair-coverage.png`](docker-treason-2026-08-15/pair-coverage.png)

> **Arm ≠ init:** `armGround` is latch open, not duel open. See [`arm-vs-init.md`](docker-treason-2026-08-15/arm-vs-init.md).
...
- [`arm-vs-init.md`](docker-treason-2026-08-15/arm-vs-init.md) — latch vs init fire
- [`rescue-episodes.md`](docker-treason-2026-08-15/rescue-episodes.md) — bleed episode causes
- [`pair-coverage.md`](docker-treason-2026-08-15/pair-coverage.md) — missing unordered pairs
- [`match-pairs.md`](docker-treason-2026-08-15/match-pairs.md) — per-match table
- JSON: [`summary.json`](docker-treason-2026-08-15/summary.json)
