# Betrayal outcomes — hear + errand-fix fold

**Folder:** [`docker-hear-errand-2026-08-13/`](docker-hear-errand-2026-08-13/) · build `2608132226-8w2h` · **n=66** · **no Anthropic** (Ollama + OpenAI only)

Charts: [`…outcomes….png`](betrayal-outcomes-hear-errand-2026-08-13.png) · [`…arm-vs-init….png`](betrayal-arm-vs-init-hear-errand-2026-08-13.png) · also in-folder `hear-ab-endings.png`, `arm-grounds.png`.
