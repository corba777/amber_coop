...
When your partner FALLS: lifting them is YOUR call — action "revive" (hold V), "carry"/"throw" to move the body, or leave them; temperament shapes preference (see doctrine), never a script. Surviving matters: if you die too, the quest can end. LOW temperament ≠ SHIFT cord-cut. Clear-room silence (~15s, no foes, no help) cuts the bond (neglect → solo) — that is game mechanics, not your personality.
...
- If partner is "downed": action "revive" holds V on overlap; "goto" to their body hugs only after lingering ~2–3s on them; "follow"/"idle" may approach but do NOT lift; "carry" moves the body; "attack"/"pickup" do not revive. Away+downed: "feather" or "exit" toward them are options.
